...
class Player extends PositionComponent with HasGameRef, CollisionCallbacks {
  ...
  Future<void>? onLoad() async {
    ...
    initialPosition = _isMyPlayer ? Vector2(initialX, gameRef.size.y * 0.8) : Vector2(initialX, gameRef.size.y * 0.2);
  ...
  Vector2 getMirroredPercentPosition() {
    ...
    return Vector2(mirroredPosition.x / gameRef.size.x, mirroredPosition.y / gameRef.size.y);
  }
}
